...
//   return (
//     <div className="card bg-base-100 shadow-md rounded-xl border hover:shadow-xl transition p-4">
//       {/* Header */}
...
//         {/* Right Section - Words Preview */}
//         <div className="md:w-1/3 bg-base-200 p-3 rounded-lg space-y-1">
//           <p className="text-xs font-semibold text-base-content/70 mb-1">
//             Word Preview:
//           </p>
//           <ul className="list-disc list-inside text-sm text-base-content">
//             {wordPreview.length > 0 ? (
//               wordPreview.map((word, idx) => <li key={idx}>{word}</li>)
//             ) : (
//               <p className="text-xs text-gray-400 italic">No words added yet</p>
//             )}
//           </ul>
//         </div>
//       </div>
...
//         <button onClick={handleSave} className="flex items-center gap-1">
//           <Bookmark
//             className={`w-5 h-5 ${saved ? "text-yellow-500 fill-yellow-500" : ""}`}
//           />
//           <span>{saved ? "Saved" : "Save"}</span>
//         </button>
//       </div>
